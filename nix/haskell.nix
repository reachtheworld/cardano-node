...
let
  ...
  src = (buildPackages.haskell-nix.haskellLib.cleanGit {
    name = "cardano-node-src";
    src = ../.;
  });

  projectPackages =  lib.attrNames (buildPackages.haskell-nix.haskellLib.selectProjectPackages
    (buildPackages.haskell-nix.cabalProject' (mkProjectArgs [])).hsPkgs);
